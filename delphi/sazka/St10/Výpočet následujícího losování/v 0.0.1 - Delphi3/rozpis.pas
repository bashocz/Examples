...
procedure TRozpisWindow.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TRozpisWindow.Button2Click(Sender: TObject);
var
...
procedure TRozpisWindow.Button1Click(Sender: TObject);
begin
  Printer.Canvas.Font:=RichEdit1.Font;
  RichEdit1.Print('');
end;

procedure TRozpisWindow.Button3Click(Sender: TObject);
const
